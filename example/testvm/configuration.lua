...
-- local arch = repos.arch_repo("http://mirror.cpsc.ucalgary.ca/mirror/archlinux.org")
-- local aur = repos.aur_repo("yay", "https://aur.archlinux.org/yay-bin.git")
local arch = Arch("http://mirror.cpsc.ucalgary.ca/mirror/archlinux.org")
local aur = AUR("yay", "https://aur.archlinux.org/yay-bin.git")
local flatpak = Flatpak("flathub")


return {
    -- repos = {
    --     arch = repos.arch_repo("http://mirror.cpsc.ucalgary.ca/mirror/archlinux.org"),
    ...
    system = {
        ...
        hardware = {
            sane = {
                enable = true,
                extra_packages = arch("sane-airscan"),
            },
            pipewire = {
                enable = true,
                extra_packages = arch(
