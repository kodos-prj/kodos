print("Demo configuration - Chisel Cross-Distribution Package Manager")
...
return {
    -- Use Chisel cross-distribution package manager
    base_distribution = "chisel",
