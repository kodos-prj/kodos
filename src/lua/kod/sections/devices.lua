                       ...
                       if has_root_partition then
                        ...
                        if has_root_partition then
                           ...
                           table.insert(steps, {
                               ...
                               command = "mount -t proc proc /mnt/proc && mount -t sysfs sys /mnt/sys && mount -o bind /dev /mnt/dev && mount -o bind /dev/pts /mnt/dev/pts && mount -o bind /run /mnt/run && ln -sf /proc/mounts /mnt/etc/mtab",
                               chroot = false,
                               order = 41,
