...
# Arch
def install_essentials_pkgs(base_pkgs: Dict, mount_point: str, dry_run: bool = False):
    """
    ...
    execute(f"chisel --base-dir {mount_point}/kod --symlink-prefix {mount_point} install {' '.join(kernel + base)}", dry_run=dry_run)
